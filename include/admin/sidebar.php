...
<div class="sidebar-wrapper" data-simplebar="true">
	<div class="sidebar-header">
		<div>
			<img src="../assets/images/BFF-logo.png" class="logo-icon" alt="logo icon" style="width: 175px;">
		</div>
	...
	<ul class="metismenu" id="menu">
		...
		<li class="menu-label">Movies & Content</li>
		<li>
			<a href="../movie-insert/">
				<div class="parent-icon"><i class="bx bx-video-recording"></i>
				</div>
				<div class="menu-title">Insert Movie</div>
			</a>
		</li>
		<li>
			<a href="../banner-content/">
				...
				<div class="menu-title">Banner Content</div>
			</a>
		</li>
		<li>
			<a href="../instagram-post/">
				<div class="parent-icon"><i class="bx bx-images"></i>
				</div>
				<div class="menu-title">Instagram Post</div>
			</a>
		</li>
		<li>
			<a href="../sponsor-post/">
				...
				<div class="menu-title">Sponsor Post</div>
			</a>
		</li>
		...
		<li>
			<a href="../scan-invoice/">
				...
				<div class="menu-title">Scan Invoice</div>
			</a>
		</li>
		<li>
			<a href="../users/">
