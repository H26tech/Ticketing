...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO movies (title, description, release_date, poster_image, time_start, time_end, duration, genre, trailer_link) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssssiss", $movie_name, $description, $date, $thumbnail_path, $time_start, $time_end, $duration_minutes, $genre, $trailer_link);
